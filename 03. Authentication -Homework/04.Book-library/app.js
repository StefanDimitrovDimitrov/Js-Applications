function start() {
    ...
    document.querySelector('#editForm [type="button"]').addEventListener("click", cancelEditAction);
    document.querySelector("table").addEventListener("click", editOrDeleteBook);
