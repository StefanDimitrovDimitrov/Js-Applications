...
function createMovieCard(movie, likes, ownLike) {
  ...
  if (userId != null) {
    if (userId == movie._ownerId) {
      ...
      controls.appendChild(
        e("a", { className: "btn btn-danger", href: "#", onClick:(e)=> showEdit(movie._id) }, "Edit"));
    } else if(ownLike.length == 0) {
      controls.appendChild(e("a",{ className: "btn btn-danger", href: "#", onClick: likeMovie },"Like"));
    }
  }
  ...
  element.appendChild(e("div",{ className: "row bg-light text-dark" },e("h1", {}, `Movie title: ${movie.title}`),e("div",{ className:"col-md-8" },e("img", { className: "img-thumbnail", src: movie.img })),controls));
